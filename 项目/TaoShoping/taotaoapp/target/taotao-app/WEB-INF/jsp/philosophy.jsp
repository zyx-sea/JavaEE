												...
												<figure>
													<div class="snipcart-item block">
														<div class="snipcart-thumb">
															...
															<p>${productList[0].bookName} ${productList[0].bookNo}</p>
															<h4>$
							...
							methods: {
								getData: function () {
									...
									$.post('/findBookPh', null, function (result) {
										self.productList ="<%=session.getAttribute("productList")%>";
