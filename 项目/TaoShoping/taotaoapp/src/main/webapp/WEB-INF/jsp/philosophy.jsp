...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="${pageContext.request.contextPath}/index">Home</a><span>|</span></li>
				<li>哲学</li>
			</ul>
		</div>
	</div>
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<li><a href="philosophy.jsp">哲学</a></li>
					</ul>
				 </div><!-- /.navbar-collapse -->
			</nav>
		</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="wthree_footer_copy">
				<p>© 2016 Grocery Store. All rights reserved | Design by {{msg}}<a href="http://xmoban.cn/">xmoban.cn</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
